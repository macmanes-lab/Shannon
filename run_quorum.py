...
if paired_end == False:
    ...
    run_cmd(quorum_path + jobs_string + " -q33 --prefix " + base_file + " " + reads_files[0])
...
# If one end of pair is filtered out, add the non filtered-out end to unpaired_reads.fasta
    ...
    run_cmd(quorum_path + jobs_string + " -q33 --prefix " + base_file + " " +  new_reads1_file + " " + new_reads2_file)
